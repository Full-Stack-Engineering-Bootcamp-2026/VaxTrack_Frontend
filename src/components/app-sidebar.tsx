...
import { BarChart3, BellRing, ClipboardList, LayoutGrid, LogOut, Plus, Settings, Users } from "lucide-react"
const menuItems = [
    {
        title: "Overview",
        icon: LayoutGrid,
        ...
        <Sidebar>
            <SidebarHeader className="px-5 pt-6 pb-8">
                <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#7C3AED] text-white font-bold shadow-sm">
                        O
                    </div>
            ...
            <SidebarContent className="px-3">
                ...
                <div className="px-1 pb-6 pt-10">
                    <button className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#7C3AED] text-sm font-medium text-white shadow-sm transition hover:bg-[#6D28D9]">
